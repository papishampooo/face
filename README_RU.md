...
- Опция 'Force Upscale' внутри вкладки 'Upscale': апскейл выполнится, даже если не было обнаружено ни одного лица
...
2. Внутри SD Web-UI перейдите во вкладку "Extensions", загрузите список доступных расширений (вкладка "Available") и введите "ReActor" в строке поиска или же вставьте ссылку `https://codeberg.org/Gourieff/sd-webui-reactor` в "Install from URL" - и нажмите "Install"
...
5. Запустите SD.Next, перейдите во вкладку "Extensions", вставьте эту ссылку `https://codeberg.org/Gourieff/sd-webui-reactor` в "Install from URL" и нажмите "Install"
...
1. В активном WebUI перейдите во вкладку "Extensions", загрузите список доступных расширений (вкладка "Available") и введите "ReActor" в строке поиска или же вставьте ссылку `https://codeberg.org/Gourieff/sd-webui-reactor` в "Install from URL" - и нажмите "Install"
...
- **[Поддержка](https://codeberg.org/Gourieff/comfyui-reactor-node) ComfyUI**
...
Полностью удалите папку `sd-webui-reactor` внутри директории `extensions`, запустите Терминал или Консоль (cmd) и выполните `git clone https://codeberg.org/Gourieff/sd-webui-reactor`
...
Инструкция здесь: [ReActor Node](https://codeberg.org/Gourieff/comfyui-reactor-node)
